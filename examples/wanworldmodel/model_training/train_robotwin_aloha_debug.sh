...
model_id_with_origin_paths="Wan-AI/Wan2.2-TI2V-5B:diffusion_pytorch_model*.safetensors,Wan-AI/Wan2.2-TI2V-5B:models_t5_umt5-xxl-enc-bf16.pth,Wan-AI/Wan2.2-TI2V-5B:Wan2.2_VAE.pth"  # 模型仓库和权重匹配规则。
tokenizer_path="models/Wan-AI/Wan2.2-TI2V-5B/google/umt5-xxl"  # tokenizer 路径。
...
eval_max_samples=2  # eval 最多评估多少个 window。
